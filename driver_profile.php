...
<html lang="en">
    ...
    <body>
            ...
            <div class="container">
                <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                  ...
                  <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                    <li><a href="driver_home.php" class="nav-link px-2 link-secondary">Home</a></li>
              ...
              <?php
                ...
                $user=$_SESSION["name"];
                $sql = "SELECT * FROM drivers where Driver_id='$user'";
        ...
        <td width=100>Charge per unit Distance</td>
        </tr>";       
        ...
        print "</table>";
            ...
            $sql = "SELECT SUM(price) from history where driver_id=$user AND to_time IS NOT NULL";
            $result = mysqli_query($conn, $sql);
            $row = $result->fetch_assoc();
            $earn=$row['SUM(price)'];
            $earn=0.3*$earn;
            echo "Total Earnings = ".$earn;
              ?>
        </main>
