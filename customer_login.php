...
<html lang="en">
  <head>
    ...
    <title>Customer Log In · CAB</title>
...
<main class="form-signin">
  <form method="post">
    <img class="mb-4" src="assets/brand/person-circle.svg" alt="A customer log in icon" width="144" height="144">
    <h1 class="h3 mb-3 fw-normal">Customer Log In</h1>
    ...
    <input type = "submit"  class="w-100 btn btn-lg btn-primary" value='Login'>&nbsp;
      <button type = "button" class="w-100 btn btn-lg btn-outline-primary" onclick="document.location='customer_register.php'" padding-bottom>New customer? Register Here</button>
