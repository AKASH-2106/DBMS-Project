            ...
            <div class="container">
                <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
                  ...
                  <div class="col-md-3 text-end">
                    <button type="button" onclick="document.location='driver_profile.php'" class="btn btn-primary">Profile</button>
                    <button type="button" onclick="document.location='driver_login.php'" class="btn btn-outline-primary me-2">Log out</button>
                  </div>
                </header>
              </div>
              ...
              <br>
              <br>
              <h2 style = "padding-left: 15%; text-align: left;">Your Previous Transactions Are</h2>
              <?php
                ...
                $user=$_SESSION["name"];
                $sql = "SELECT * FROM history where driver_id='$user' AND to_time IS NOT NULL";
...
<br>
<br>
<h2 style = "padding-left: 15%; text-align: left;">Your Current Bookings Are</h2>
              <?php
                $conn = mysqli_connect('localhost', 'root', 'prasad', 'b\'proj\'');
                if(!$conn)
                {
                ...
                $user=$_SESSION["name"];
                $sql = "SELECT * FROM history where driver_id=$user AND to_time IS NULL";
                $result = mysqli_query($conn, $sql);
...
<button type="submit" class="btn btn-primary" id="view_cabs">Completed Allotted Ride</button>
        </main>
...
<?php
  if ($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $user=$_SESSION["name"];
    $sql = "UPDATE history set to_time='$tdate' where driver_id='$user' AND to_time IS NULL";
    $result = mysqli_query($conn, $sql);
    $sql = "UPDATE drivers set Booked='N' where driver_id='$user'";
    $result = mysqli_query($conn, $sql);
